...
if ($input != $solution) {
    $score -= 250; // decrement by 250 for incorrect answer
}
  ...
  <script>
    ...
    function handleInput() {
      ...
      if (input.value == solution) {
        ...
        // end game if 3 incorrect attempts
        ...
        if(score >= 100)
        // If the answer is incorrect, the score decrement  by 250
		    score -= 250;
...
function handleTimeOut() {
  ...
  if (numQuestions >= 10) {
    ...
    message.innerHTML = "";
      ...
      // Thanks to Stackoverflow for refenced and learned the "async function" and fetching
      function startup() {
        fetchText();
      }
